...
LOCAL_CFLAGS += -DSQLITE_HAS_CODEC=1
LOCAL_CFLAGS += -DSQLITE_USER_AUTHENTICATION=1
...
LOCAL_CFLAGS += -Wno-uninitialized -Wno-parentheses -Wno-writable-strings -Wno-deprecated-register -Wno-reserved-user-defined-literal
LOCAL_CPPFLAGS += -Wno-conversion-null -Wno-writable-strings
